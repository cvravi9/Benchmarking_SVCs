...
df3 = pd.read_csv("Updated_Strelka_0.3_SNV.vcf", sep = '\t', index_col= False)
df4 = pd.read_csv("Updated_Strelka_0.5_SNV.vcf", sep = '\t', index_col= False)
df5 = pd.read_csv("Updated_Strelka_0.7_SNV.vcf", sep = '\t', index_col= False)

# Inputing vcf files for Indels.
df6 = pd.read_csv("Updated_Strelka_0.3_INDEL.vcf", sep = '\t', index_col= False)
df7 = pd.read_csv("Updated_Strelka_0.5_INDEL.vcf", sep = '\t', index_col= False)
df8 = pd.read_csv("Updated_Strelka_0.7_INDEL.vcf", sep = '\t', index_col= False)
