...
df = pd.read_csv("Updated_Strelka_0.7_SNV.vcf", sep = '\t', index_col= False)
df1 = pd.read_csv("Updated_VarScan_0.7_SNP.vcf", sep = '\t', index_col= False)
...
plt.savefig('Tumor_Purity_0.7_SNPs_Plot.png', dpi = 300)
