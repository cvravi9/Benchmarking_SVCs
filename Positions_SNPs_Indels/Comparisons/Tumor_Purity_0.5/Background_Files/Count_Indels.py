...
df = pd.read_csv("Updated_Strelka_0.5_INDEL.vcf", sep = '\t', index_col= False)
df1 = pd.read_csv("Updated_VarScan_0.5_INDEL.vcf", sep = '\t', index_col= False)
...
plt.savefig('Tumor_Purity_0.5_Indels_Plot.png', dpi = 300)
