...
df = pd.read_csv("Updated_Strelka_0.5.vcf", sep = '\t', index_col= False)
...
plt.title("Positions")
plt.show()
plt.savefig('Tumor_Purity_0.5_Positions_Plot.pdf')
plt.savefig('Tumor_Purity_0.5_Positions_Plot.png',  dpi = 300)
