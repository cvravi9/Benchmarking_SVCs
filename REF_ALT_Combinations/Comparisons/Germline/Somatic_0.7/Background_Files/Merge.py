...
df = pd.read_csv("FreeBayes_Somatic_0.7.csv", sep = '\t', index_col= False)
df1 = pd.read_csv("Strelka_Somatic_0.7.csv", sep = '\t', index_col= False)
df2 = pd.read_csv("VarScan_Somatic_0.7.csv", sep = '\t', index_col= False)
...
Second.columns = ['REF', 'ALT', 'FreeBayes_Somatic_0.7', 'Strelka_Somatic_0.7', 'VarScan_Somatic_0.7']
print(Second)
