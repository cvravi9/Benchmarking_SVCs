...
# Step 1 - 'cut -f 1-2,3-4 Input-VCF-File > Output-VCF-File'
...
dff = pd.read_csv("Selected_VarScan_0.3.vcf", sep = '\t', index_col= False)
...
dff.to_csv('Selected_VarScan_0.3.csv', sep='\t', index = None)
