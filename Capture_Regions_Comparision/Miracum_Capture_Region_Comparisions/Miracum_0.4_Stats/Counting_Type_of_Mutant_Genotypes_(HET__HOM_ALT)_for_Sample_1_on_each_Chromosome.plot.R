            ...
            plotdata = read.table(	paste0('Miracum_0.4_Stats/Counting_Type_of_Mutant_Genotypes_(HET__HOM_ALT)_for_Sample_1_on_each_Chromosome', '.txt'),
            ...
            png(paste0('Miracum_0.4_Stats/Counting_Type_of_Mutant_Genotypes_(HET__HOM_ALT)_for_Sample_1_on_each_Chromosome', '.', figtype, '.png'),
