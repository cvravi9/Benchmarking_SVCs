            ...
            plotdata = read.table(	paste0('Miracum_0.4_Stats/Number_of_Variants_on_Each_Chromosome', '.txt'),
            ...
            png(paste0('Miracum_0.4_Stats/Number_of_Variants_on_Each_Chromosome', '.', figtype, '.png'),
