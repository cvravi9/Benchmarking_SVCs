            ...
            plotdata = read.table(	paste0('Miracum_0.4_Stats/Overall_allele_frequency_distribution', '.txt'),
            ...
            png(paste0('Miracum_0.4_Stats/Overall_allele_frequency_distribution', '.', figtype, '.png'),
