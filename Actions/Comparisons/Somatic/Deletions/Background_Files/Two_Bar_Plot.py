...
plt.bar(r1, a1, color='#FFA500', width=width, edgecolor='white', label='Strelka_Somatic_Deletions')
plt.bar(r2, a2, color='#DC143C', width=width, edgecolor='white', label='VarScan_Somatic_Deletions')
