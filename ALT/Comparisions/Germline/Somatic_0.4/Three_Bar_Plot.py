...
# Make the plot
plt.bar(r1, a1, color='#FFD700', width=width, edgecolor='white', label='FreeBayes_Somatic_0.4')
plt.bar(r2, a2, color='#FFA500', width=width, edgecolor='white', label='Strelka_Somatic_0.4')
plt.bar(r3, a3, color='#DC143C', width=width, edgecolor='white', label='VarScan_Somatic_0.4')
