...
Second = Second.drop(['Strelka_Normal_0.5_Read_Depth', 'Strelka_Tumor_0.5_Read_Depth', 'Strelka_Normal_0.7_Read_Depth', 'Strelka_Tumor_0.7_Read_Depth', 'VarScan_Normal_0.5_Read_Depth', 'VarScan_Tumor_0.5_Read_Depth', 'VarScan_Normal_0.7_Read_Depth', 'VarScan_Tumor_0.7_Read_Depth'], axis=1)
print(Second)
...
Type = ['Strelka_Normal_0.3', 'Strelka_Tumor_0.3', 'VarScan_Normal_0.3', 'VarScan_Tumor_0.3', 'Truth_Data']
...
# Saving the results in csv.
df.to_csv('Tumor_Purity_0.3_Read_Depth_Statistics.csv', sep=',', index = False)
