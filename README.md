...
Another tool to compare two vcf files is the "VCFToolZ". The command is **"vcftoolz compare first-vcf second-vcf"** and using this command both the textual outcome along with the venn diagrams comparing snps and positions are obtained.
