...
df2 = pd.read_csv("Updated_StrelkaPP_0.3.vcf", sep = '\t', index_col= False)
df3 = pd.read_csv("Updated_StrelkaPP_0.5.vcf", sep = '\t', index_col= False)
df4 = pd.read_csv("Updated_StrelkaPP_0.7.vcf", sep = '\t', index_col= False)
...
df.to_csv('StrelkaPP_Benchmarking.csv', sep=',', index = False)
