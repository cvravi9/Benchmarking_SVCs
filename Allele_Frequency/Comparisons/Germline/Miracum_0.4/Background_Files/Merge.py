...
Third = Second.drop(['CHROM_POS', 'FreeBayes_Miracum_0.7', 'FreeBayes_Somatic_0.4', 'FreeBayes_Somatic_0.7', 'Strelka_Miracum_0.7', 'Strelka_Somatic_0.4', 'Strelka_Somatic_0.7', 'VarScan_Miracum_0.7', 'VarScan_Somatic_0.4', 'VarScan_Somatic_0.7'], axis=1)
print(Third)

# Saving the results in csv.
Third.to_csv('All_Germline_Miracum_0.4.csv', sep='\t', index=False, encoding='utf-8')
Third.to_csv('All_Germline_Miracum_0.4_Plot.csv', sep='\t', index = None)
