...
Second.to_csv('Tumor_Purity_0.5.csv', sep=',', index = None)
...
# Saving the results in csv.
dff8.to_csv('Tumor_Purity_0.5_AF_Counts.csv', sep=',', index = None)
...
plt.savefig('Tumor_Purity_0.5_AF_Plot.png', dpi = 300)
