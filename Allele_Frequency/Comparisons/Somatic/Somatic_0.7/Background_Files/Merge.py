...
Second = First.drop(['CHROM_POS', 'Strelka_Miracum_0.4', 'Strelka_Miracum_0.7', 'Strelka_Somatic_0.4', 'VarScan_Miracum_0.4', 'VarScan_Miracum_0.7', 'VarScan_Somatic_0.4'], axis=1)
print(Second)

# Saving the results in csv.
Second.to_csv('All_Somatic_Somatic_0.7.csv', sep='\t', index=False, encoding='utf-8')
Second.to_csv('All_Somatic_Somatic_0.7_Plot.csv', sep='\t', index = None)
