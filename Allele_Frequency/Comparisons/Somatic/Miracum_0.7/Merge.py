...
Second = First.drop(['CHROM_POS', 'Strelka_Miracum_0.7', 'Strelka_Somatic_0.4', 'Strelka_Somatic_0.7', 'VarScan_Miracum_0.7', 'VarScan_Somatic_0.4', 'VarScan_Somatic_0.7'], axis=1)
print(Second)

# Saving the results in csv.
Second.to_csv('All_Somatic_Miracum_0.4.csv', sep='\t', index=False, encoding='utf-8')
Second.to_csv('All_Somatic_Miracum_0.4_Plot.csv', sep='\t', index = None)
