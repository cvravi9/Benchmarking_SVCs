...
dff = pd.read_csv("FreeBayes_Miracum_0.4.frq", sep = '\t', index_col= False, error_bad_lines=False)
...
# Reading csv files and concatinating "CHROM" and "POS"
dff1 = pd.read_csv("FreeBayes_Miracum_0.7.frq", sep = '\t', index_col= False, error_bad_lines=False)
...
# Reading csv files and concatinating "CHROM" and "POS"
dff2 = pd.read_csv("FreeBayes_Somatic_0.4.frq", sep = '\t', index_col= False, error_bad_lines=False)
...
# Reading csv files and concatinating "CHROM" and "POS"
dff3 = pd.read_csv("FreeBayes_Somatic_0.7.frq", sep = '\t', index_col= False, error_bad_lines=False)
...
Second_Result.columns = ['CHROM-POS', 'Miracum_0.4_AF', 'Miracum_0.7_AF', 'Somatic_0.4_AF', 'Somatic_0.7_AF']
print(Second_Result)

# Saving the results in csv.
Second_Result.to_csv('FreeBayes_AF_Values.csv', index=True, encoding='utf-8')
