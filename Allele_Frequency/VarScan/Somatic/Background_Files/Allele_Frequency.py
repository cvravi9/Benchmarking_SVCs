...
dff = pd.read_csv("VarScan_Miracum_0.4.frq", sep = '\t', index_col= False)
...
# Reading csv files and concatinating "CHROM" and "POS"
dff1 = pd.read_csv("VarScan_Miracum_0.7.frq", sep = '\t', index_col= False)
...
# Reading csv files and concatinating "CHROM" and "POS"
dff2 = pd.read_csv("VarScan_Somatic_0.4.frq", sep = '\t', index_col= False)
...
# Reading csv files and concatinating "CHROM" and "POS"
dff3 = pd.read_csv("VarScan_Somatic_0.7.frq", sep = '\t', index_col= False)
...
Second_Result.to_csv('VarScan_Somatic_AF_Values.csv', index=False, encoding='utf-8')
Second_Result.to_csv('VarScan_Somatic_AF_Plot_Values.csv', sep='\t', index = None)
