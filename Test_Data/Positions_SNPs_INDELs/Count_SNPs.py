...
df = pd.read_csv("Updated_Test_SNPs.vcf", sep = '\t', index_col= False)
df1 = pd.read_csv("Updated_Test.annot_SNPs.vcf", sep = '\t', index_col= False)
...
# Position outcomes.
print("Number of Test SNPs:")
Strelka_Positions = len(df)
print(Strelka_Positions)

print("Number of Test.annot SNPs:")
VarScan_Positions = len(df1)
print(VarScan_Positions)

print("Number of SNPs in Test and Test.annot:")
...
data = {'Type': ['Test', 'Test.annot', 'Common_SNPs'], 'Positions': [Strelka_Positions, VarScan_Positions, Strelka_VarScan_Positions]}
