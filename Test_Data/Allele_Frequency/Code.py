...
# Adding columns
dff['Test_Allele_Frequency'] = ['Less than 0.25', 'Between 0.25 to 0.50', 'Between 0.50 to 0.75', 'Above 0.75']
...
dff.to_csv('Test_AF.csv', sep=',', index = False)
dff.to_html("Test_AF.html")
...
plt.title("Test_AF_Percentage")
plt.savefig('Test_AF_Plot.pdf', dpi = 300)
