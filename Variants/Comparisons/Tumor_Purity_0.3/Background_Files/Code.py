...
dff1 = pd.read_csv("Updated_VarScan_0.3_SNP.vcf", sep = '\t', index_col= False)
...
data1 = {'REF': ['A', 'A', 'A', 'A', 'T', 'T', 'T', 'T', 'G', 'G', 'G', 'G', 'C', 'C', 'C', 'C'], 'ALT': ['A', 'T', 'G', 'C', 'T', 'A', 'G', 'C', 'G', 'A', 'T', 'C', 'C', 'A', 'T', 'G'], 'VarScan_0.3': [AA2, AT2, AG2, AC2, TT2, TA2, TG2, TC2, GG2, GA2, GT2, GC2, CC2, CA2, CT2, CG2]}
...
# Mentioning the column names and inputing the csv file.
Second.columns = ['REF', 'ALT', 'Strelka_0.3', 'VarScan_0.3', 'Truth_Data']
print(Second)
...
dff = pd.read_csv("Tumor_Purity_0.3_Counts.csv", sep = ',', index_col= False, error_bad_lines=False)
