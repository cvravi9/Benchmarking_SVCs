...
dff = pd.read_csv("Updated_Strelka_0.7_SNV.vcf", sep = '\t', index_col= False)
dff1 = pd.read_csv("Updated_VarScan_0.7_SNP.vcf", sep = '\t', index_col= False)
...
data = {'REF': ['A', 'A', 'A', 'A', 'T', 'T', 'T', 'T', 'G', 'G', 'G', 'G', 'C', 'C', 'C', 'C'], 'ALT': ['A', 'T', 'G', 'C', 'T', 'A', 'G', 'C', 'G', 'A', 'T', 'C', 'C', 'A', 'T', 'G'], 'Strelka_0.7': [AA1, AT1, AG1, AC1, TT1, TA1, TG1, TC1, GG1, GA1, GT1, GC1, CC1, CA1, CT1, CG1]}
data1 = {'REF': ['A', 'A', 'A', 'A', 'T', 'T', 'T', 'T', 'G', 'G', 'G', 'G', 'C', 'C', 'C', 'C'], 'ALT': ['A', 'T', 'G', 'C', 'T', 'A', 'G', 'C', 'G', 'A', 'T', 'C', 'C', 'A', 'T', 'G'], 'VarScan_0.7': [AA2, AT2, AG2, AC2, TT2, TA2, TG2, TC2, GG2, GA2, GT2, GC2, CC2, CA2, CT2, CG2]}
...
# Mentioning the column names and inputing the csv file.
Second.columns = ['REF', 'ALT', 'Strelka_0.7', 'VarScan_0.7', 'Truth_Data']
print(Second)

# Saving the results in csv.
Second.to_csv('Tumor_Purity_0.7_Counts.csv', sep=',', index = None)

# Reading csv files and concatinating "CHROM" and "POS"
dff = pd.read_csv("Tumor_Purity_0.7_Counts.csv", sep = ',', index_col= False, error_bad_lines=False)
...
# Make the plot
plt.bar(r1, a1, color='#FFD700', width=width, edgecolor='white', label='Strelka_0.7')
plt.bar(r2, a2, color='#FFA500', width=width, edgecolor='white', label='VarScan_0.7')
...
plt.legend()
plt.show()
plt.savefig('Tumor_Purity_0.7_Plot.pdf')
plt.savefig('Tumor_Purity_0.7_Plot.png', dpi = 300)
